        ...
        case 'sendComplaints':;
            ...
            $('#sendComplaintsForm').on('submit', async function (e) {
                ...
                const complaintData = {
                    ...
                    QuejasLocId: parseInt($('#hiddenLocId').val()) || null,
                    QuejasTipoPersona: parseInt($('#QuejasTipoPersona').val()) || false,
                    QuejasSexo: ($('#QuejasSexo').val() || ($('#QuejasTipoPersona').val() === '1' ? false : null)),
                    QuejasEdad: parseInt($('#QuejasEdad').val()) || null,
                    QuejasFecResolucion: convertDate($('#QuejasFecResolucion').val()),
                    QuejasFecNotificacion: convertDate($('#QuejasFecNotificacion').val()),
                    QuejasRespuesta: parseInt($('#QuejasRespuesta').val()) || ($('#QuejasEstatus').val() === '2' ? false : null),
